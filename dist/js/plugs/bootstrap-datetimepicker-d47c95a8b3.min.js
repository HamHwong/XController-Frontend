...
(function (a) {
    ...
    d.fn.datetimepicker = function (k) {
        ...
        var j;
        this.each(function () {
            var n = d(this), m = n.data('datetimepicker'), l = (typeof k === 'undefined' ? 'undefined' : _typeof(k)) === 'object' && k;
            if (!m) {
    ...
    var c = {
            ...
            isLeapYear: function isLeapYear(i) {
            ...
            nonpunctuation: /[^ -\/:-@\[-`{-~\t\n\rTZ]+/g,
            parseFormat: function parseFormat(l, j) {
