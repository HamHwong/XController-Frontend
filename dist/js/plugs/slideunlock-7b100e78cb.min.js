...
function SliderUnlock(g, c, f, e) {
    ...
    var d = {
            labelTip: typeof c.labelTip !== 'undefined' ? c.labelTip : 'Slide to Unlock',
            successLabelTip: typeof c.successLabelTip !== 'undefined' ? c.successLabelTip : 'Success',
...
SliderUnlock.prototype.reset = function () {
    var a = this;
    a.index = 0;
    a.elm.find('#label').animate({ left: a.index }, a.opts.duration).next('#lableTip').animate({ opacity: 1 }, a.opts.duration);
    a.updateView();
};
